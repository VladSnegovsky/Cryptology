...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("plain text message = " + RSAUtils.bigIntegerToString(decimalMessage));
...
//                List<BigInteger> decimalMessage = RSA.messageToDecimal(message);
//        System.out.println("plain text message = " + RSAUtils.bigIntegerToString(decimalMessage));
//        System.out.println("decimal message    = " + RSAUtils.bigIntegerSum(decimalMessage));
//        List<BigInteger> encryption = RSA.encryptMessage(message);
//        System.out.println("decimal encripted  = " + RSAUtils.bigIntegerSum(encryption));
